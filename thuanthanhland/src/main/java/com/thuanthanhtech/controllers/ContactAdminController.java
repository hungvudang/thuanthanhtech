...
public class ContactAdminController {
	...
	public String updateCategory(@PathVariable("id") Integer id, @ModelAttribute("contact") Contact contact, RedirectAttributes ra) {
	...
	if(opContact.isPresent()) {
		...
		return "redirect:/contact/detail/"+nContact.getId();
	}else {
